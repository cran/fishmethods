...
libname agi "C:\temp\int2007";

*** LOCATION OF CATCH ESTIMATE DATASETS ***;
libname est "c:\temp\est2007";
...
*** SPECIES CODE ***;
%let species = '8835250101'; ** ScUp **;
%let label = SFLDER;           ** for output length frequency file name **;
...
%let estput=EST.AG_&yr.4;

*%let estput=cmb.AG_&yr.1 cmb.AG_&yr.2 cmb.AG_&yr.3 cmb.AG_&yr.4 cmb.AG_&yr.5 cmb.AG_&yr.6;

*** TITLES FOR TABLES ***;
%let header = "Length Frequencies for Landed BLUEFISH ALL AREAS COMBINED WAVE 4 year 2007 - MASSACHUSETTS";
