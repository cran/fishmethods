...
### Error Messages
    ...
    if(is.null(hphi)) stop("hphi (initial tag loss rates) for harvested fish) are missing.")
    if(is.null(rphi)) stop("rphi (initial tag loss rates) for fish released with tag removed are missing.")
